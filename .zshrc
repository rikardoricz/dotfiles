...
export LC_TIME="pl_PL.UTF-8" waybar
...
alias ytdl-music='echo TODO'
alias tsc='sudo systemctl start tailscaled'
alias tscup='sudo tailscale up'
alias tscdown='sudo tailscale down'
...
# pnpm
export PNPM_HOME="/home/rikardo/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
